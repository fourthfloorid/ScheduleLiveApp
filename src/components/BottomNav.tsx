import { Home, Calendar, Tv, Tag, LogOut, Users, UserCircle, CalendarCheck } from 'lucide-react';
...
export default function BottomNav({ user, currentPage, onNavigate, onLogout }: BottomNavProps) {
  const menuItems = [
    ...
    { id: 'brand-schedule' as Page, label: 'Schedule', icon: CalendarCheck, roles: ['admin'] },
